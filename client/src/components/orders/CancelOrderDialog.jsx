...
const LOSS_OPTIONS = [
  ...
  },
  {
    value: "with_loss",
    label: "With Loss",
    description: "Declare lost ingredients per item, refund minus loss cost",
    icon: "trendingDown",
  },
];
...
export default function CancelOrderDialog({
  ...
  const calculatedPartial = useMemo(
    () => Math.max(totalAmount - totalLossCost, 0),
    [totalAmount, totalLossCost],
  );
  ...
  }, [refundOption, totalAmount, calculatedPartial, customRefundAmount]);
  ...
  function handleConfirm() {
    ...
    onConfirm?.({
      ...
      reason: finalReason || reason || null,
