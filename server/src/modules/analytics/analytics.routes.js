...
import { getAnalyticsQuerySchema, getTrendQuerySchema, getExportQuerySchema, getVariantProfitQuerySchema, getWasteDetailsQuerySchema } from "./analytics.validation.js";
...
router.get("/ingredients/profitability", validateQuery(getVariantProfitQuerySchema), analyticsController.getIngredientProfitability);
