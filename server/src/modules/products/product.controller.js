...
export const productController = {
  ...
  async updateVariants(req, res) {
    try {
      const product = await productService.updateVariants(req.params.id, req.body.variants, req.user.id);
  ...
  async deactivateProduct(req, res) {
    try {
      const product = await productService.deactivate(req.params.id, req.user.id);
